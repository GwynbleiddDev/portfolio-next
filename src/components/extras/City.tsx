export default function City() {
  return (
    ...
    >
      ...
      <circle className="city-sun" cx="400" cy="300" r="270" fill="#FAEFBE" />
      <rect
        x="0"
        y="400"
        width="800"
      ...
      <defs>
        <radialGradient id="exampleGradient">
          <stop offset="30%" stopColor="#030712" />
          <stop offset="99%" stopColor="#030712" />
        </radialGradient>
      </defs>
      
      <rect x="0" y="100" width="800" height="5" fill="#030712" />
      <rect x="0" y="140" width="800" height="10" fill="#030712" />
      <rect x="0" y="210" width="800" height="25" fill="#030712" />
      ...
      {/* Estrellas */}
      <circle className="city-star" cx="40" cy="100" r="2" fill="#fff" />
      <circle className="city-star" cx="120" cy="150" r="2" fill="#fff" />
      <circle className="city-star" cx="740" cy="60" r="2" fill="#fff" />
      <circle className="city-star" cx="240" cy="40" r="2" fill="#fff" />
      <circle className="city-star" cx="70" cy="240" r="2" fill="#fff" />
      <circle className="city-star" cx="690" cy="140" r="2" fill="#fff" />
      <circle className="city-star" cx="790" cy="240" r="2" fill="#fff" />
    </svg>
  );
}
